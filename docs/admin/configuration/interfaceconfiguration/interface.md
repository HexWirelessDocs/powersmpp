...
| Field | Description |
|-------|-------------|
| **System ID** | Username used to connect to the ESME account |
| **Password** | Authentication password for the ESME account |
| **Whitelist IP** | Only connections from this IP are allowed |
